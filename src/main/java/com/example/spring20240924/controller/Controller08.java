...
public class Controller08 {
    ...
    // address라는 attribute 꺼내서 HTML 완성홰서 응답하기
    ...
    public String sub2(Model model) {
        ...
        model.addAttribute("some2", List.of("java", "spring"));
        model.addAttribute("some3", List.of("java", "html"));

        // 주로 서용하는 것
        // String, 기본타입(Wrapper), 배열, List, Map, JavaBean
    ...
    public String sub6(Model model) {
        // attribute 에 List 넣기
        model.addAttribute("names", List.of("명보", "뮹규", "유빈"));
        return null;
    }
