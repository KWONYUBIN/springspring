...
import com.example.springspring.dto.c27.Employee;
import com.example.springspring.dto.c26.Customer;
import com.example.springspring.dto.c26.Product;
    ...
    public String sub9(Customer customer, RedirectAttributes rttr) {
        ...
        try {
            ...
            try (con; pstmt) {
                ...
                pstmt.executeUpdate();
                rttr.addFlashAttribute("message", customer.getId() + "번 고객님이 수정되었습니다.");
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
