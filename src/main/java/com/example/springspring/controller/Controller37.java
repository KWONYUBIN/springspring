...
import com.example.springspring.mapper.Mapper07;
...
public class Controller37 {
    ...
    // 2번째 메소드, mapper 에 delete2 메소드 작성
    @GetMapping("sub2")
...
//        country = "korea";
    ...
    public String sub5(String name, String city, String country,
        ...
        rttr.addFlashAttribute("message" ,c + "명 고객정보 등록됨");
