...
USE db1;
#   모든 레코드는 고유해야 한다
# 적어도 하나의 UNIQUE NOT NULL 컬럼이 있어야함 (Primary Key 컬럼이 있어야한다)
# UNIQUE NOT NULL을 프라이머리키라고 함
...
INSERT INTO my_table30
    VALUE ('134324', '소년이 온다', '한강', 10000),
    ('1234123', '채식주의자', '한강', 20000),
    ('1451312', 'git', 'linus', 30000),
    ('6122344', '소년이 온다', '한강', 10000);
SELECT *
FROM my_table30;
